...
function Login({ setToken }) {
  ...
  // Hover to Speak state
  const [hoverToSpeak, setHoverToSpeak] = useState(() => {
    const saved = localStorage.getItem('hoverToSpeak');
    return saved === 'true';
  });
  ...
  }, [useFaceLogin, isLoaded]); // Note: handleFaceLogin is missing from deps – consider using useCallback
