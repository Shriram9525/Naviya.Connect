      ...
      {!selectedGame ? (
        ...
        >
          <header className="games-header">
            ...
            >
              <p style={{ margin: 0, fontSize: "1rem", color: "white", fontWeight: "500", letterSpacing: "0.5px" }}>
            ...
            {categories[category].games.map((game) => (
              ...
              >
                <div
                  ...
                  style={{ marginBottom: "15px", display: "flex", alignItems: "center", justifyContent: "center", width: "60px", height: "60px", backgroundColor: "#E6F0FA", borderRadius: "16px" }}
                >
                  <game.icon size={32} color="#0B3C5D" />
                </div>
                <h3 style={{ marginBottom: "8px", color: "#0B3C5D", fontSize: "1.4rem" }}>{game.name}</h3>
                <p style={{ color: "#666", marginBottom: "15px", flexGrow: 1 }}>
                  {game.description}
                </p>
                <p style={{ fontSize: "0.85rem", color: "#34C759", fontWeight: "600", marginBottom: "5px" }}>
                  🎯 {game.importance}
                </p>
                {game.accessibility && (
                  <span
                ...
                <button
                  className="btn"
                  style={{ marginTop: "20px", width: "100%", padding: "12px", minHeight: "auto", fontSize: "1rem" }}
                >
                  Play Now →
                </button>
              </motion.div>
